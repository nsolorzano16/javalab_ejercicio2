...
public interface ConversorSoap {
    ...
    @RequestWrapper(localName = "FaC", targetNamespace = "http://elGuille/WebServices", className = "clientws.service.FaC")
    @ResponseWrapper(localName = "FaCResponse", targetNamespace = "http://elGuille/WebServices", className = "clientws.service.FaCResponse")
    public double faC(
    ...
    @RequestWrapper(localName = "CaF", targetNamespace = "http://elGuille/WebServices", className = "clientws.service.CaF")
    @ResponseWrapper(localName = "CaFResponse", targetNamespace = "http://elGuille/WebServices", className = "clientws.service.CaFResponse")
    public double caF(
        @WebParam(name = "valor", targetNamespace = "http://elGuille/WebServices")
        double valor);
